...
using Moq;
using iControl.Server.Areas.Identity.Pages.Account.Manage;
...
namespace iControl.Tests
{
    public class TestData
    {
        ...
        public iControlUser Admin1 { get; } = new iControlUser()
        {
        ...
        public iControlUser Admin2 { get; private set; } 
        ...
        public iControlUser User1 { get; private set; }

        public iControlUser User2 { get; private set; }
        ...
        private async Task Init()
        {
            ...
            var userManager = IoCActivator.ServiceProvider.GetRequiredService<UserManager<iControlUser>>();
