...
using iControl.Desktop.Core.Utilities;
using iControl.Desktop.Win.Services;
using iControl.Shared.Models;
using iControl.Shared.Models.RemoteControlDtos;
using System;
...
namespace iControl.Tests
{
    ...
    public class ManualTests
    {
        ...
        {
            using var mrs = Assembly.GetExecutingAssembly().GetManifestResourceStream($"iControl.Tests.Resources.{frameFileName}.jpg");
