...
using iControl.Desktop.XPlat.Native.Linux;
    ...
    public class MainWindowViewModel : BrandedViewModelBase
    {
        ...
        public async Task PromptForHostName()
        {
                ...
                (serverUri.Scheme != Uri.UriSchemeHttp && serverUri.Scheme != Uri.UriSchemeHttps))
            {
                ...
                await MessageBox.Show("Server URL must be a valid Uri (e.g. https://app.iControl.one).", "Invalid Server URL", MessageBoxType.OK);
                return;
            }
