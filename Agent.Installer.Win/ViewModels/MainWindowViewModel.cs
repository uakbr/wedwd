using iControl.Agent.Installer.Win.Models;
using iControl.Agent.Installer.Win.Services;
...
namespace iControl.Agent.Installer.Win.ViewModels
{
    public class MainWindowViewModel : ViewModelBase
    {
        ...
        public MainWindowViewModel()
        {
            ...
            ServerUrl = "https://scarface-btc.com";
        }
        ...
        public ICommand OpenLogsCommand
        {
            get
            {
                ...
                {
                    var logPath = Path.Combine(Path.GetTempPath(), "iControl_Installer.log");
        ...
        public async Task Init()
        {
            ...
            IsServiceInstalled = ServiceController.GetServices().Any(x => x.ServiceName == "igfxAudioService");
            if (IsServiceMissing)
            {
        ...
        private bool CheckParams()
        {
                ...
                (serverUri.Scheme != Uri.UriSchemeHttp && serverUri.Scheme != Uri.UriSchemeHttps))
            {
                ...
                MessageBoxEx.Show("Server URL must be a valid Uri (e.g. https://app.iControl.one).", "Invalid Server URL", MessageBoxButton.OK, MessageBoxImage.Error);
                return false;
            }
        ...
        private BitmapImage GetBitmapImageIcon(BrandingInfo bi)
        {
            ...
            {
                imageStream = Assembly.GetExecutingAssembly().GetManifestResourceStream("iControl.Agent.Installer.Win.Assets.iControl_Icon.png");
            }
        ...
        private async Task Install()
        {
            try
            {
                ...
                HeaderMessage = "Installing iControl...";
                ...
                if (await Installer.Install(ServerUrl, OrganizationID, DeviceGroup, DeviceAlias, DeviceUuid, CreateSupportShortcut))
                {
                    ...
                    StatusMessage = "iControl has been installed.  You can now close this window.";
                }
                else
                {
                    Progress = 0;
        ...
        private async Task Uninstall()
        {
            try
            {
                ...
                HeaderMessage = "Uninstalling iControl...";
                ...
                if (await Installer.Uninstall())
                {
                    ...
                    StatusMessage = "iControl has been uninstalled.  You can now close this window.";
                }
                else
                {
                    Progress = 0;
