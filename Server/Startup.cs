...
using iControl.Server.Areas.Identity;
using System;
using System.IO;
using System.Linq;
using System.Net;
...
namespace iControl.Server
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddIdentity<iControlUser, IdentityRole>(options =>
            {
            ...
            services.AddScoped<AuthenticationStateProvider, RevalidatingIdentityAuthenticationStateProvider<iControlUser>>();
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "iControl API", Version = "v1" });
            });
            ...
            ILoggerFactory loggerFactory)
        {
            ...
            app.UseSwaggerUI(c =>
            {
                c.SwaggerEndpoint("/swagger/v1/swagger.json", "iControl API V1");
            });
