...
namespace iControl.Server.Areas.Identity.Pages.Account
{
    [AllowAnonymous]
    public class ForgotPasswordModel : PageModel
    {
        ...
        public ForgotPasswordModel(UserManager<iControlUser> userManager,
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            if (ModelState.IsValid)
            {
                ...
                var emailResult = await _emailSender.SendEmailAsync(
                    Input.Email,
                    "Reset Password",
                    $"<img src='{Request.Scheme}://{Request.Host}/images/iControl_Logo.png'/><br><br>Please reset your iControl password by <a href='{HtmlEncoder.Default.Encode(callbackUrl)}'>clicking here</a>.");
