...
namespace iControl.Server.Pages
{
    ...
    public partial class ServerConfig : AuthComponentBase
    {
        ...
        private readonly List<iControlUser> _userList = new();
        ...
        private IEnumerable<iControlUser> UserList
        {
            get
            {
        ...
        private async Task SaveAndTestSmtpSettings()
        {
            ...
            var success = await EmailSender.SendEmailAsync(User.Email, "iControl Test Email", "Congratulations! Your SMTP settings are working!", User.OrganizationID);
            if (success)
            {
        ...
        private void SetIsServerAdmin(ChangeEventArgs ev, iControlUser user)
        {
