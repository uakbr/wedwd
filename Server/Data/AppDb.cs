...
namespace iControl.Server.Data
{
    public class AppDb : IdentityDbContext
    {
        ...
        public new DbSet<iControlUser> Users { get; set; }
        ...
        protected override void OnModelCreating(ModelBuilder builder)
        {
            ...
            builder.Entity<IdentityUser>().ToTable("iControlUsers");

            builder.Entity<Organization>()
                .HasMany(x => x.Devices)
                .WithOne(x => x.Organization);
            builder.Entity<Organization>()
                .HasMany(x => x.iControlUsers)
                .WithOne(x => x.Organization);
            builder.Entity<Organization>()
            ...
            builder.Entity<iControlUser>()
               .HasOne(x => x.Organization)
               .WithMany(x => x.iControlUsers);
            ...
            builder.Entity<iControlUser>()
                ...
                .HasConversion(
                    ...
                    x => JsonSerializer.Deserialize<iControlUserOptions>(x, (JsonSerializerOptions)null));
            builder.Entity<iControlUser>()
                .HasMany(x => x.SavedScripts)
                .WithOne(x => x.Creator);
            builder.Entity<iControlUser>()
