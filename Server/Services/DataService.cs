...
namespace iControl.Server.Services
{
    ...
    public interface IDataService
    {
        ...
        Task<string> AddSharedFile(string filePath, string organizationID);
        ...
        bool DoesUserHaveAccessToDevice(string deviceID, iControlUser iControlUser);

        bool DoesUserHaveAccessToDevice(string deviceID, string iControlUserID);

        string[] FilterDeviceIDsByUserPermission(string[] deviceIDs, iControlUser iControlUser);
        ...
        iControlUser[] GetAllUsersForServer();

        Task<iControlUser[]> GetAllUsersInOrganization(string orgId);
        ...
        int GetDeviceCount(iControlUser user);
        ...
        Task<iControlUser> GetUserAsync(string username);

        iControlUser GetUserByID(string userID);

        iControlUser GetUserByNameWithOrg(string userName);

        iControlUserOptions GetUserOptions(string userName);
        ...
        Task SetDisplayName(iControlUser user, string displayName);
        ...
        void UpdateUserOptions(string userName, iControlUserOptions options);
    ...
    public class DataService : IDataService
    {
        ...
        public async Task<string> AddSharedFile(string filePath, string organizationID)
        {
            var fileContents = new byte[File.ReadAllBytes(filePath).Length];
            using var stream = File.OpenRead(filePath);
            await stream.ReadAsync(fileContents.AsMemory(0, (int)File.ReadAllBytes(filePath).Length));
            return await AddSharedFileInternal(Path.GetFileName(filePath), fileContents, "application/octet-stream", organizationID);
            //int fileSize = File.ReadAllBytes(filePath).Length;
            //return await AddSharedFileInternal(Path.GetFileName(filePath), , "application/octet-stream", organizationID);;
        }
        ...
        public bool DoesUserHaveAccessToDevice(string deviceID, iControlUser iControlUser)
        {
            if (iControlUser is null)
            {
                return false;
            }
            ...
            return dbContext.Devices
                ...
                .Any(device => device.OrganizationID == iControlUser.OrganizationID &&
                    device.ID == deviceID &&
                    (
                        iControlUser.IsAdministrator ||
                        string.IsNullOrWhiteSpace(device.DeviceGroupID) ||
                        device.DeviceGroup.Users.Any(user => user.Id == iControlUser.Id
                    )));
        }

        public bool DoesUserHaveAccessToDevice(string deviceID, string iControlUserID)
        {
            using var dbContext = _appDbFactory.GetContext();

            var iControlUser = dbContext.Users.Find(iControlUserID);

            return DoesUserHaveAccessToDevice(deviceID, iControlUser);
        }

        public string[] FilterDeviceIDsByUserPermission(string[] deviceIDs, iControlUser iControlUser)
        {
            using var dbContext = _appDbFactory.GetContext();
            ...
            return dbContext.Devices
                ...
                .ThenInclude(x => x.Users)
                .Where(device =>
                    device.OrganizationID == iControlUser.OrganizationID &&
        ...
        public iControlUser[] GetAllUsersForServer()
        {
            using var dbContext = _appDbFactory.GetContext();
        ...
        public async Task<iControlUser[]> GetAllUsersInOrganization(string orgId)
        {
            if (string.IsNullOrWhiteSpace(orgId))
            {
                return Array.Empty<iControlUser>();
            }
            ...
            return organization.iControlUsers.ToArray();
        }
        ...
        public int GetDeviceCount(iControlUser user)
        {
            using var dbContext = _appDbFactory.GetContext();
        ...
        public async Task<iControlUser> GetUserAsync(string username)
        {
            if (string.IsNullOrWhiteSpace(username))
            {
                return null;
        ...
        public iControlUser GetUserByID(string userID)
        {
        ...
        public iControlUser GetUserByNameWithOrg(string userName)
        {
            if (userName == null)
            {
                return null;
        ...
        public iControlUserOptions GetUserOptions(string userName)
        {
            using var dbContext = _appDbFactory.GetContext();
        ...
        public bool JoinViaInvitation(string userName, string inviteID)
        {
            ...
            organization.iControlUsers.Add(user);
        ...
        public async Task SetDisplayName(iControlUser user, string displayName)
        {
            using var dbContext = _appDbFactory.GetContext();
        ...
        public void UpdateUserOptions(string userName, iControlUserOptions options)
        {
            using var dbContext = _appDbFactory.GetContext();
        ...
        public bool ValidateApiKey(string keyId, string apiSecret, string requestPath, string remoteIP)
        {
            ...
            var hasher = new PasswordHasher<iControlUser>();
