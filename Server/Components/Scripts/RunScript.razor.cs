...
using iControl.Server.Migrations.PostgreSql;
using iControl.Server.Migrations.Sqlite;
using iControl.Server.Migrations.SqlServer;
using iControl.Server.Pages;
...
namespace iControl.Server.Components.Scripts
{
    [Authorize]
